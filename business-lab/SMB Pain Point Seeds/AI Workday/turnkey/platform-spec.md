# Platform spec — AI Workday

*apb/1 · compiled 2026-08-07T07:49:49Z · `sha256:76e2f3e08b93782d00650326f694a154`*
...
- **Platform**: 6 modules — Waitlist, People, Announcements, Content, Inbox, Events
- **Deploy**: vercel — a Vercel deployment — a public URL
- **Authorization**: unattended (consent `26f43fe918d9ea04`)
...
- **dropped** `courses_lms` — this archetype never builds it
- **dropped** `membership_access` — this archetype never builds it
...
| ▣ | **Build the platform · 6 modules** | the operating app the owner works in, seeded so it opens with something in it |
...
- **about** → "AI Workday is run by one team who answer their own messages." — no About section in the profile
