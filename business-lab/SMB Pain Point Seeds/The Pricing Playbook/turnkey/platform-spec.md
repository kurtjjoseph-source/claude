# Platform spec — The Pricing Playbook

*apb/1 · compiled 2026-08-07T07:51:03Z · `sha256:3fe93a1fc9b46e946efee9bcc5e7c329`*
...
- **Platform**: 4 modules — Waitlist, People, Announcements, Content
- **Deploy**: vercel — a Vercel deployment — a public URL
- **Authorization**: unattended (consent `540a6729f77f467f`)

### Where the archetype overruled the blueprint

- **dropped** `product_catalog` — this archetype never builds it
...
| ▣ | **Build the platform · 4 modules** | the operating app the owner works in, seeded so it opens with something in it |
...
- **about** → "The Pricing Playbook is run by one team who answer their own messages." — no About section in the profile
